...
def show_tela1():
    ...
    Entradas_Today = Entradas[['Date','Time','League','Home','Away','Odd_H_Lay']]
    ...
    #                                             9.4 / (Entradas_Resultado['Odd_H_Lay']-1), -10)
    ...
    for a, b, c, d, e, f in zip(Entradas.League, 
                                Entradas.Time, Entradas.Home, 
                                Entradas.Away, Entradas.Odd_H_Lay, Entradas.IDMercado_Match_Odds):
        liga = a
        horario = b
        home = c
        away = d
